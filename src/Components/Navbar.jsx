...
const Navbar = () => {
    ...
    return (
        <div>
            <div className="navbar bg-base-100 shadow-xl border-b border-gray-300">
                <div className="navbar-start">
                    <div className="dropdown">
                        ...
                        <ul
                            tabIndex={0}
                            className="menu menu-sm dropdown-content bg-base-100 rounded-lg z-10 mt-3 w-56 p-3 shadow-lg border border-gray-200 dark:border-gray-700"
                        >
                            <li>
                                <Link
                                    to="/home"
                                ...
                                >
                                    <span
                                        className={
                                            theme === "light"
                                                ? "text-gray-900 text-lg font-normal"
